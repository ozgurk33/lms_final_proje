    ...
    return (
        <View style={styles.container}>
            <View style={styles.statsContainer}>
                <View style={styles.statCard} accessible={true} accessibilityLabel={`${stats?.totalUsers || 0} toplam kullanıcı`}>
                    <Text style={styles.statValue}>{stats?.totalUsers || 0}</Text>
                    <Text style={styles.statLabel}>Toplam Kullanıcı</Text>
                </View>
                <View style={styles.statCard} accessible={true} accessibilityLabel={`${stats?.totalCourses || 0} toplam kurs`}>
                    <Text style={styles.statValue}>{stats?.totalCourses || 0}</Text>
                    <Text style={styles.statLabel}>Toplam Kurs</Text>
                </View>
                <View style={styles.statCard} accessible={true} accessibilityLabel={`${stats?.totalEnrollments || 0} toplam kayıt`}>
            ...
            <View style={styles.menuContainer}>
                <TouchableOpacity
                    ...
                    accessibilityHint="Tüm kullanıcıları görüntüle ve yönet">
                ...
                <TouchableOpacity
                    ...
                    accessible={true}
                    accessibilityRole="button"
                    accessibilityLabel="Kurs yönetimi"
                    accessibilityHint="Kursları oluştur, düzenle ve yönet">
                    <Text style={styles.menuIcon}>📚</Text>
